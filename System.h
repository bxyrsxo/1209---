...
const int MOTOR_ENCODER_4X[6] = {2000, 2000, 2048, 2048, 2048, 2048};

const int MAX_OUTPUT_VOLTAGE = 10;
const int MIN_OUTPUT_VOLTAGE = -10;
...
struct MOTOR_DATA
{
	...
	float Cm;			// viscosoty coefficient of the system load
};

const MOTOR_DATA M_DATA[6]=
{
